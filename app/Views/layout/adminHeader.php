        ...
        <ul class="navbar-nav topbar-nav ms-md-auto align-items-center">
            ...
            <!-- <li class="nav-item topbar-icon dropdown hidden-caret">
                ...
                <ul class="dropdown-menu messages-notif-box animated fadeIn" aria-labelledby="messageDropdown">
                    ...
                    <li>
                        <div class="scroll-wrapper message-notif-scroll scrollbar-outer" style="position: relative;">
                            <div class="message-notif-scroll scrollbar-outer scroll-content" style="height: auto; margin-bottom: 0px; margin-right: 0px; max-height: 0px;">
            ...
            <li class="nav-item topbar-icon dropdown hidden-caret">
                ...
                <div class="dropdown-menu quick-actions animated fadeIn">
                    ...
                    <div class="scroll-wrapper quick-actions-scroll scrollbar-outer" style="position: relative;">
                        <div class="quick-actions-scroll scrollbar-outer scroll-content" style="height: auto; margin-bottom: 0px; margin-right: 0px; max-height: 0px;">
            ...
            <li class="nav-item topbar-user dropdown hidden-caret">
                <a class="dropdown-toggle profile-pic me-3" data-bs-toggle="dropdown" href="#" aria-expanded="false">
                    <div class="avatar-sm">
                        <?php
                        $session = session();
